...
const motherboard_t SUPPORTED_MOTHERBOARDS_LIST[] = 
{
    // H61
    {
        ...
        ASCII, ASCII_MAC_HEADER_6_SERIES, QByteArray(),
        None, NULL, NULL,
    ...
    // B75
    {
        ...
        ASCII, ASCII_MAC_HEADER_7_SERIES, QByteArray("\x25", 1),
        None, NULL, NULL,
        ...
        "P8B75-M-LX", 
        MODULE_VERSION_7_SERIES, 
        ASCII, ASCII_MAC_HEADER_7_SERIES, QByteArray("\x24", 1),
        None, NULL, NULL,
        UuidPresent, UUID_HEADER_7_SERIES,
        MbsnPresent, MBSN_HEADER_7_SERIES,
    },
    ...
    // H77
    {
        "P8H77-I",
        MODULE_VERSION_7_SERIES, 
        ASCII, ASCII_MAC_HEADER_7_SERIES, QByteArray("\x22", 1),
        None, NULL, NULL,
        UuidPresent, UUID_HEADER_7_SERIES,
        MbsnPresent, MBSN_HEADER_7_SERIES, 
    },{
        "P8H77-V",
        MODULE_VERSION_7_SERIES, 
        ASCII, ASCII_MAC_HEADER_7_SERIES, QByteArray("\x2A", 1),
        None, NULL, NULL,
        UuidPresent, UUID_HEADER_7_SERIES,
        MbsnPresent, MBSN_HEADER_7_SERIES, 
    },{
        "P8H77-V-LE",
        MODULE_VERSION_7_SERIES, 
        ASCII, ASCII_MAC_HEADER_7_SERIES, QByteArray("\x26", 1),
        None, NULL, NULL,
        UuidPresent, UUID_HEADER_7_SERIES,
        MbsnPresent, MBSN_HEADER_7_SERIES, 
    },{
        ...
        "P8H77-M-PRO",
        MODULE_VERSION_7_SERIES, 
        ASCII, ASCII_MAC_HEADER_7_SERIES, QByteArray("\x28", 1),
        None, NULL, NULL,
        UuidPresent, UUID_HEADER_7_SERIES,
        MbsnPresent, MBSN_HEADER_7_SERIES, 
    },
    ...
    // Z77
    {
        ...
        "P8Z77-V-LE", 
        MODULE_VERSION_7_SERIES, 
        ASCII, ASCII_MAC_HEADER_7_SERIES, QByteArray("\x2D", 1), 
        None, NULL, NULL, 
        UuidPresent, UUID_HEADER_7_SERIES,
        MbsnPresent, MBSN_HEADER_7_SERIES, 
    },{
        "P8Z77-V-LX", 
        MODULE_VERSION_7_SERIES, 
        ASCII, ASCII_MAC_HEADER_7_SERIES, QByteArray("\x2D\x29", 2), 
        None, NULL, NULL, 
        UuidPresent, UUID_HEADER_7_SERIES,
        MbsnPresent, MBSN_HEADER_7_SERIES, 
    },{
